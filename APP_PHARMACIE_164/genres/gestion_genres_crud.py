...
from APP_PHARMACIE_164.genres.gestion_genres_wtf_forms import FormWTFAjouterGenres
from APP_PHARMACIE_164.genres.gestion_genres_wtf_forms import FormWTFDeleteGenre
from APP_PHARMACIE_164.genres.gestion_genres_wtf_forms import FormWTFUpdateGenre
        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * from t_genre"""
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                valeurs_insertion_dictionnaire = {"value_nom_genre": name_genre}
                print("valeurs_insertion_dictionnaire ", valeurs_insertion_dictionnaire)

                strsql_insert_genre = """INSERT INTO t_genre (id_genre,nom_genre) VALUES (NULL,%(value_nom_genre)s) """
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_genre SET nom_genre = %(value_name_genre)s 
            ...
            print("data_nom_genre ", data_nom_genre, " type ", type(data_nom_genre), " genre ",
                  data_nom_genre["nom_genre"])

            # Afficher la valeur sélectionnée dans les champs du formulaire "genre_update_wtf.html"
            form_update.nom_genre_update_wtf.data = data_nom_genre["nom_genre"]
...
def genre_delete_wtf():
    data_client_attribue_genre_delete = None
    btn_submit_del = None
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_conf_del.data:
                ...
                data_client_attribue_genre_delete = session['data_client_attribue_genre_delete']
                print("data_client_attribue_genre_delete ", data_client_attribue_genre_delete)
        ...
        if request.method == "GET":
            ...
            str_sql_genres_client_delete = """SELECT id_client, nom, id_genre, nom_genre FROM t_client 
            ...
            with DBconnection() as mydb_conn:
                ...
                data_client_attribue_genre_delete = mydb_conn.fetchall()
                print("data_client_attribue_genre_delete...", data_client_attribue_genre_delete)
            ...
            form_delete.nom_genre_delete_wtf.data = data_nom_genre["nom_genre"]
    ...
    return render_template("genres/genre_delete_wtf.html",
                           ...
                           data_client_associes=data_client_attribue_genre_delete)
